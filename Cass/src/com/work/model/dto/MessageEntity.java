...
public class MessageEntity {
	...
	public MessageEntity() {
		...
		error.add("[회원가입 오류 - 모든 항목을 제대로 입력해주세요]");			// 0
		error.add("[사업자 등록 오류 - 모든 항목을 제대로 입력해주세요]");		// 1
		error.add("[회원 로그인 오류 - 아이디 또는 비밀번호가 다릅니다]");			// 2
		error.add("[사업자 로그인 오류 - 아이디 또는 비밀번호가 다릅니다]");		// 3
