...
<form action="${CONTEXT_PATH}/business/frontController?action=businessInput" method="post">
	...
	<div class="inputForm">
		...
		<h4 class="Title">비밀번호</h4><input type="password" class="input" name="businessPw" id=""businessPw"" required="required" placeholder="비밀번호를 6자 이상 입력해주세요."><br>
		...
		<h4 class="Title">사업자번호</h4><input type="text" class="input" pattern="\d{3}-\d{2}-\d{5}" name="businessNum" id="businessNum" required="required" placeholder="ex) 000-00-00000"><br>
	
		<h4 class="Title">상호명</h4><input type="text" class="input" name="businessTitle" id="businessTitle" required="required" placeholder="상호명을 입력해주세요."><br>		
